...
public interface ProductionDestributionStocksMapper {
    /**
    ...
    ProductionDistributionStocksEntity toEntity(ProductionItemResponseDto.ProductionDistributionStocksDto dto);
